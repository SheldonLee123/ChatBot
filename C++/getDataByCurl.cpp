...
int main()
{
    ...
    string url = "www.tuling123.com/openapi/api?key=a2bd87304ad4415baaaee4d249ea7eee&info=金坷垃"; //待请求的页面
    string filename = "response.txt"; //正确响应后，请请求转写成本地文件的文件名即路径，此处表示当前目录下
